...
private:
	...
	void ReadNodeHeirarchy(float AnimationTime, const aiNode * pNode, const aiMatrix4x4 & ParentTranform);
	...
	void CalcInterpolatedPositoin(aiVector3D & Out, float AnimationTime, const aiNodeAnim* pNodeAnim);
